...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        @param embeddings (n array): word embeddings (num_words, embedding_size)
    ...
    def forward(self, w):
        ...
        # Chuyển đổi từ lớp nhúng đến lớp ẩn
        x = torch.matmul(w, self.embeddings)
        x = x.view(-1, self.n_features * self.embed_size)  # Reshape if necessary
        ...
        # Chuyển đổi từ lớp ẩn đến lớp logits
